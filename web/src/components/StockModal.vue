<template>
  <div
    ...
    @click.stop
  >
    <header class="flex items-center justify-between mb-6 pb-4 border-b-solid border-gray-200">
      ...
      <button
        @click="closeModal"
        class="bg-[#f0f0f0] lowercase border-[none] rounded-full w-[35px] h-[35px] cursor-pointer text-[1.2rem] flex items-center justify-center [transition:all_0.3s_ease] hover:bg-[#e0e0e0] hover:rotate-90"
      >
        x
      </button>
    </header>
